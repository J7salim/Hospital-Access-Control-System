...
<?php
	if(isset($_POST['submit']))
	{
		...
		/*$query = "SELECT `patientNumber` FROM `medication` WHERE `patientNumber` = '$patientNumber'";
			$query_run = mysql_query($query);
			
			if (mysql_num_rows($query_run)==1)
			{
				$message = '<p style=" color:red;">Please, use the update function to update medical records.</p>';
			}else
			{*/
				...
				{
					$message = '<p style="color: red;">Failed to update medication</p>';
				}
			/*}*/	
	}
?>
...
<div id="wrapper">
	...
	<div id="container">
		...
		<!-- Emergency Patient--->
			...
			<!-- Form starts here-->
			<form class="jotform-form" action="emergency_medication.php" method="post" name="form_32743415307450" id="32743415307450" accept-charset="utf-8">
