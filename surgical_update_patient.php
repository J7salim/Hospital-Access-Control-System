...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$surgicalRoom = mysql_real_escape_string($_POST['surgicalRoom']);
		$surgicalRoom_hash = base64_encode($surgicalRoom);
		
		$emer = "UPDATE `surgical` SET `patientFirst`='$patientFirst_hash',`patientLast`='$patientLast_hash',`gender`='$gender_hash',`birthDate`='$birthDate_hash',`description`='$description_hash',`surgicalRoom`='$surgicalRoom_hash' WHERE `id`='$id'";
		if (mysql_query($emer))
		{
...
<div id="wrapper">
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Surgical Patient Updating Form</h1>
	<div class="line"></div>
	<div class="intro">This is only for updating patient.</div>
	<center><p><?php echo $message; ?></p></center>
	
	<!-- Begin Slider -->
	<?php
		$patientNumber = $_GET['id'];
		$sql = "SELECT * FROM surgical WHERE patientNumber = '$patientNumber'";
    ...
    <!-- End Slider --> 
	<!-- Form start here -->
	<form class="jotform-form" action="surgical_update_patient.php" method="post" name="form_32638191299464" id="32638191299464" accept-charset="utf-8">
	  ...
	  <div class="form-all">
		<ul class="form-section">
		  <li class="form-line" id="id_8">
			...
			<div id="cid_8" class="form-input"><span class="form-sub-label-container"><input type="text" readonly="readonly" class="form-readonly  form-textbox validate[required]" data-type="input-textbox" id="input_8" name="patientNumber" size="20" value="<?php echo $patientNumber; ?>" />
		  ...
		  <li class="form-line" id="id_6">
			...
			<div id="cid_6" class="form-input">
			  <select class="form-dropdown validate[required]" style="width:150px" id="input_6" name="surgicalRoom">
				<option value="">  </option>
