			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="emergency_invoice.php?id=<?php echo $rows['patientNumber']; ?>">Invoice</a></td>
					</tr>
				<?php	
					}
				?>
			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="surgical_invoice.php?id=<?php echo $rows['patientNumber']; ?>">Invoice</a></td>
					</tr>
				<?php	
					}
				?>
			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="observation_invoice.php?id=<?php echo $rows['patientNumber']; ?>">Invoice</a></td>
					</tr>
				<?php	
					}
				?>
			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="others_invoice.php?id=<?php echo $rows['patientNumber']; ?>">Invoice</a></td>
					</tr>
				<?php	
					}
				?>
