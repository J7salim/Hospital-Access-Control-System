...
<div id="wrapper">
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Billing and Receivables</h1>
	<div class="line"></div>
	<?php if (checkadmission()) { ?>	
	<div class="intro"></div>
    ...
    <div class="one-half">
    <h3><a href="view_patient_bill.php"><img src="style/images/new_invoice.png" width="72" height="72" alt="" />New Bill</a></h3>
    ...
    <h3><img src="style/images/receivables.png" width="72" height="72" alt="" />Receivables</h3>
    ...
    <div class="one-half">
    <h3><img src="style/images/reports.png" width="72" height="72" alt="" />Reports</h3>
    <p>This category entitles patient who are undergoing for observation only</p>
    </div>
    
    <!--<div class="one-half last">
    <h3><img src="style/images/others.png" alt="" />Others</h3>
