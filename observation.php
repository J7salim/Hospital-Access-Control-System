...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$emer = "INSERT INTO observation VALUES ('', '$patientNumber', '$patientFirst_hash', '$patientLast_hash', '$gender_hash', '$birthDate_hash', '$description_hash', '$observationRoom_hash')";
		if (mysql_query($emer))
		{
...
<div id="wrapper">
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Observation Registration Form</h1>
	<div class="line"></div>
	<div class="intro">This is only for observation patient only.</div>
    ...
    <!-- End Slider --> 
	<!-- Form start here -->
	<form class="jotform-form" action="observation.php" method="post" name="form_32638191299464" id="32638191299464" accept-charset="utf-8">
		...
		<ul class="form-section">
		  ...
		  <li class="form-line" id="id_6">
			<label class="form-label-left" id="label_6" for="input_6">
			  Observation Room<span class="form-required">*</span>
			</label>
