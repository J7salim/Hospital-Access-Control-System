			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="view_emergency.php?id=<?php echo $rows['patientNumber']; ?>">View</a></td>
						
						<td><a href="emergency_medication.php?id=<?php echo $rows['patientNumber']; ?>">Medication</a></td>
					</tr>
				<?php	
					}
				?>
			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="view_surgical.php?id=<?php echo $rows['patientNumber']; ?>">View</a></td>
						
						<td><a href="surgical_medication.php?id=<?php echo $rows['patientNumber']; ?>">Medication</a></td>
					</tr>
				<?php	
					}
				?>
			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="view_observation.php?id=<?php echo $rows['patientNumber']; ?>">View</a></td>
						
						<td><a href="observation_medication.php?id=<?php echo $rows['patientNumber']; ?>">Medication</a></td>
					</tr>
				<?php	
					}
				?>
			...
			<table>
				...
				?>	
					<tr>
						...
						<td><a href="view_others.php?id=<?php echo $rows['patientNumber']; ?>">View</a></td>
						
						<td><a href="others_medication.php?id=<?php echo $rows['patientNumber']; ?>">Medication</a></td>
					</tr>
				<?php	
					}
				?>
