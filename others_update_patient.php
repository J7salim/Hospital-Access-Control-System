...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$Room_hash = base64_encode($Room);
		
		$emer = "UPDATE `unknownpatient` SET `patientFirst`='$patientFirst_hash',`patientLast`='$patientLast_hash',`gender`='$gender_hash',`birthDate`='$birthDate_hash',`description`='$description_hash',`Room`='$Room_hash' WHERE `id`='$id'";
		if (mysql_query($emer))
		{
...
<div id="wrapper">
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Unknown Patient Updating Form</h1>
	<div class="line"></div>
    ...
    <!-- End Slider --> 
	<!-- Form start here -->
	<form class="jotform-form" action="others_update_patient.php" method="post" name="form_32638191299464" id="32638191299464" accept-charset="utf-8">
		...
		<ul class="form-section">
		  ...
		  <li class="form-line" id="id_6">
			...
			<div id="cid_6" class="form-input">
			  <select class="form-dropdown validate[required]" style="width:150px" id="input_6" name="Room">
				<option value="">  </option>
