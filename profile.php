...
<div id="wrapper">
	...
	<div id="container">
		<div id="main">
			...
			<!-- End of the main table for staff profile -->
			<table>
				<tr>
					<th>Administrator</th>
					<th>Staff</th>
					<th>Doctor</th>
					<th>Admission Feature</th>
					<th>Medical Feature</th>
					<th>Stocks Feature</th>
					<th>Bill Feature</th>
					<th>Patient Feature</th>
				</tr>
				<!-- Test Template Features -->
				<?php
					$id = $_GET['id'];
				...
				?>	
					<tr>
						...
						<td><?php echo $rows['admission']; ?></td>
						
						<td><?php echo $rows['medical']; ?></td>
			...
			<h3>Note</h3>
			<p style="color: red;">1 == Yes </p>
			<p style="color: red;">0 == NO </p>
			<h4>Please, use <span style="color: green">User Management</span> specific feature on the left panel for updating and deleting a record</h4>	
		</div>
	</div>	
