...
<div id="wrapper">
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Patients Panel</h1>
	<div class="line"></div>
	<div class="intro">Please, select from the existing options from left panel or use the below options for patient respectively.</div>
    ...
    <div class="one-half">
    <h3><a href="view_patient.php"><img src="style/images/view_patient.png" alt="" />View Patient Records</a></h3>
    <p>Use this option to view and search all or particular patient records at any specific time.</p>
    </div>
    
    <div class="one-half last">
    <h3><a href="view_patient.php"><img src="style/images/update_patient.png" width="72" height="72" alt="" />Update Patient Record</a></h3>
    <p>Use this option to update all or particular patient records at any specific time.</p>
    </div>
    ...
    <div class="one-half">
    <h3><img src="style/images/delete_patient.png" width="72" height="72" alt="" />Delete Patient Record</h3>
    <p>Use this option to delete all or particular patient records at any specific time.</p>
	<p style="color:red;">Note: Use this option with cautious, once records deleted it will never be recovered.</p>
    </div>
    
    <div class="one-half last">
    <h3><img src="style/images/reports.png" width="72" height="72" alt="" />General Patients Reports</h3>
    <p>Summary of all the patients in the hospital</p>
    </div>
