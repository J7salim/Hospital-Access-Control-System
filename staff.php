...
<div id="wrapper">
	...
	<div class="line"></div>
	<div class="intro">Please, select from the existing options from left panel or use the below options for staff respectively.</div>
    ...
    <div class="one-half">
    <h3><a href="view_staff.php"><img src="style/images/view_patient.png" alt="" />View Staff Records</a></h3>
    <p>Use this option to view and search all or particular staff records at any specific time.</p>
    </div>
    
    <div class="one-half last">
    <h3><a href="update_staff.php"><img src="style/images/update_patient.png" width="72" height="72" alt="" />Update Staff Record</a></h3>
    <p>Use this option to update all or particular staff records at any specific time.</p>
    </div>
    ...
    <div class="one-half">
	<h3><a href="new_staff.php"><img src="style/images/new_staff.png" width="72" height="72" alt="" />Register New Staff</a></h3>
    <p>Staff registration</p>
	<p style="color:red;">Note: Ensure that each staff is registered under proper respective category. For example Doctor, Nurse etc</p>
    </div>
    
    
    <div class="one-half last">
    <h3><a href="staff_report.php"><img src="style/images/reports.png" width="72" height="72" alt="" />General Staff Reports</a></h3>
    <p>Summary of all the staff in the hospital</p>
    </div>

	<div class="clear"></div>
	<div class="one-half">
	<h3><a href="delete_staff.php"><img src="style/images/delete_patient.png" width="72" height="72" alt="" />Delete Staff Record</a></h3>
    <p>Use this option to delete all or particular staff records at any specific time.</p>
	<p style="color:red;">Note: Use this option with cautious, once records deleted it will never be recovered.</p>
    </div>
