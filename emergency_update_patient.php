...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$emer = "UPDATE `emergency` SET `patientFirst`='$patientFirst_hash',`patientLast`='$patientLast_hash',`gender`='$gender_hash',`birthDate`='$birthDate_hash',`description`='$description_hash',`emergencyRoom`='$emergencyRoom_hash' WHERE `id`='$id'";
		if (mysql_query($emer))
		{
...
<div id="wrapper">
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Emergency Patient Updating Form</h1>
	<div class="line"></div>
    ...
    <!-- End Slider --> 
	<!-- Form start here -->
	<form class="jotform-form" action="emergency_update_patient.php" method="post" name="form_32638191299464" id="32638191299464" accept-charset="utf-8">
