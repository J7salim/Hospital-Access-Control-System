...
<?php
	if (isset($_POST['submit']))
	{
		...
		$query = "INSERT INTO `stocks` VALUES ('', '$bactchid_hash', '$drugname_hash', '$drugtype_hash', '$quantity_hash', '$expired_hash', '$price_hash')";
		if ($results = mysql_query($query))
		{
			header('Location: success.php');
		}else
		{
			$message = '<center><p style="color: red;">Failed to add stock</p></center>';
		}
...
<link type="text/css" rel="stylesheet" href="css/styles/form.css?v3.1.84"/>
<link href="css/calendarview.css?v3.1.84" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="http://cdn.jotfor.ms/css/styles/nova.css?3.1.84" />
<link type="text/css" media="print" rel="stylesheet" href="http://cdn.jotfor.ms/css/printForm.css?3.1.84" />
<style type="text/css">
    .form-label{
...
<script src="js/prototype.js?v=3.1.84" type="text/javascript"></script>
<script src="js/json2.js?v=3.1.84" type="text/javascript"></script>
<script src="js/protoplus.js?v=3.1.84" type="text/javascript"></script>
<script src="js/protoplus-ui.js?v=3.1.84" type="text/javascript"></script>
<script src="js/jotform.js?v=3.1.84" type="text/javascript"></script>
<script src="js/calendarview.js?v=3.1.84" type="text/javascript"></script>
...
<div id="wrapper">
	...
	<!-- Begin Content -->
	<div id="content">
	<h1 class="title">Hospital Stocks</h1>
	<div class="line"></div>
	<?php if (checkadmission()) { ?>	
	<div class="intro"></div>
	...
	<!-- start of form -->
	<?php echo $message; ?>
	<form class="jotform-form" action="add_stocks.php" method="post" name="form_32743415307450" id="32743415307450" accept-charset="utf-8">
	  ...
	  <div class="form-all">
		<ul class="form-section">
		  <li class="form-line" id="id_1">
			...
			<div id="cid_1" class="form-input"><span class="form-sub-label-container"><input type="text" class=" form-textbox validate[required]" data-type="input-textbox" readonly="readonly" id="input_1" name="batchid" size="20" value="<?php $string = rand(); echo $string; ?>" />
				<label class="form-sub-label" for="input_1"> This id is automatic generated </label></span>
			</div>
		  </li>
